...
CLU_min_dist = (
    0 * u.Mpc
)  # change to 5 or something similar to exclude nearby resolved galaxies
CLU_max_dist = 200.0 * u.Mpc


def compile_CLU_catalog(
    filename="CLU_20170106.hdf5", min_dist=CLU_min_dist, max_dist=CLU_max_dist
):
    # Get CLU catalog
    ...
    d = {
        ...
        "CLU_ra": CLU_ra,
        "CLU_dec": CLU_dec,
        "CLU_dist_Mpc": CLU_dist,
        "CLU_z": CLU_z,
        "CLU_SDSS_rMag": CLU_SDSS_rMag,
        "CLU_a": CLU_a,
        "CLU_b2a": CLU_b2a,
        "CLU_pa": CLU_pa,
    }  # ,'CLU_petro_rMag':CLU_petro_rMag,'CLU_SDSS_rMagErr':CLU_SDSS_rMagErr,'CLU_petro_rMagErr':CLU_petro_rMagErr}
